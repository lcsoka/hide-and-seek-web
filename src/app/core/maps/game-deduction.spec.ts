...
function resolved(partial: Partial<ResolvedQuestion>): ResolvedQuestion {
  return {
    ...
    answer: null,
    ask: { lat: null, lng: null, radius_m: null, feature: null, start_lat: null, start_lng: null },
...
describe('resolvedQuestionsToDeduction', () => {
  it('maps a radar question to a radar deduction (within from yes/no)', () => {
    const out = resolvedQuestionsToDeduction([
      resolved({ seq: 3, category: 'radar', answer: { answer: 'no' }, ask: { lat: 47.5, lng: 19.0, radius_m: 1609, feature: null, start_lat: null, start_lng: null } }),
    ]);
  ...
  it('maps a thermometer question using start (A) and end (B) positions', () => {
    const out = resolvedQuestionsToDeduction([
      resolved({
        ...
        ask: { lat: 47.5, lng: 19.0, radius_m: null, feature: null, start_lat: 47.5, start_lng: 19.0 },
